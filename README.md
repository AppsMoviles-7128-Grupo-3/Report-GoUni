...
| **Versión**   | **Fecha** | **Autor**                         | **Descripción**                                                                                                                                                         |
|---------------|-----------|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **#01 - TF**   | 21/06/25  | David Polanco, Alessandro David   | - Continuacion de desarrollo de interfaces en Flutter <br> - implemenacion de funcionalidades de rutas, reservas, configuracion del usuario (pasajeros)                 |
| **#01 - TF** | 21/06/25  | Chirinos Zúñiga, Rodrigo          | - Implementación de módulo de reserva <br> - Redacción del Sprint 2 y entrevistas de validación                                                                         |
| **#01 - TF** | 21/06/25  | Cruz Ticona, Aaron                | - Desarrollo de funcionalidades para conductores <br> - Gestión de solicitudes activas y publicación de asientos                                                        |
| **#01 - TF** | 21/06/25  | Zevallos Linares, Alessandro      | - Desarrollo en Kotlin para app de conductores <br> - Registro de conductor y lógica de backend móvil inicial <br> - Redacción del Sprint 2 y entrevistas de validación |
...
|---------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software.** | **David Polanco, Alessandro Alonso**, <br><br>**TB1**: Se actualizaron y aplicaron conocimientos clave sobre metodologías ágiles, análisis de usuarios y diseño centrado en la experiencia. A través de herramientas como el Lean UX Canvas, entrevistas, mapeos de viaje del usuario y empatía, logramos identificar con mayor precisión los problemas y necesidades de los estudiantes universitarios respecto a su movilidad. <br><br> **TP**: El equipo profundizó en el diseño UI/UX, la arquitectura de la información y la implementación técnica de la solución, lo que implicó la actualización y aplicación de conceptos avanzados en desarrollo de software, gestión de proyectos ágiles y buenas prácticas de colaboración en entornos de control de versiones. <br><br> **TB2**: El equipo profundizó en el desarrollo backend de la app móvil, y el desarrollo final de la aplicación móvil en kotlin, así pudiendo lograr cubrir el desarrollo de las dos capas, y también mostrando nuestro productos  nuestro público objetivo. <br><br>  **TF**:Se pudieron implementar nuevas funcionalidades clave para el flujo del usuario tanto de conductor como de pasajero, como funcionalidades de reservas, configuracion, precios, detalles de vehiculos del conductor, etc. **Chirinos Zúñiga, Rodrigo Manuel**, <br><br>**TB1**: Se identificaron necesidades del usuario, especificando requisitos y diseñando soluciones mediante metodologías como Lean UX y Domain-Driven Design. <br> <br>**TP**: Se identificaron las necesidades que podrían tener los usuarios a la hora de  registrarse e iniciar sesión, se realzizaron de manera correcta las vistas mencionadas. <br> <br> **TB2**: Participé en el desarrollo de la aplicación móvil para conductores utilizando Kotlin, desarrollo nativo en Android y el uso de herramientas como ViewModel, LiveData y Retrofit. Además, colaboré en la elaboración del reporte para esta entrega.<br><br>  **TF**:Se pudieron implementar nuevas funcionalidades clave para el flujo del usuario tanto de pasajero, como funcionalidades del inicio de sesión y registro del usuario. <br> <br> **Cruz Ticona, Aaron Alejandro**, <br><br>**TB1**: Participé activamente en el diseño e implementación de los bounded context, aplicando principios de Domain-Driven Design. Además, colaboré en la definición de los segmentos objetivos de usuarios. <br> <br>**TP**: Identifiqué la primera etapa de desarrollo de la aplicacion en base a nuestro primer sprint para realizar la vista de planes. <br> <br>**TB2**: Desarrollo e investigación de tecnologías que serán usadas en la app de Android para conductores. <br><br> **TF**: Despliegue luego de investigación de la versión finalizada de la aplicación para conductores. <br> <br>**Zevallos Linares, Alessandro Netto**, <br><br>**TB1**: Documenté los distintos componentes de la arquitectura del sistema utilizando una aproximación basada en Domain-Driven Design.Esta labor me permitió profundizar en la comprensión de la separación de responsabilidades y las ventajas de una arquitectura bien estructurada. <br> <br> **TP**: Diseñé la interfaz de usuario de la página principal (Landing Page) y el diseño UX/UI de la versión móvil del sistema. Utilicé principios de usabilidad, accesibilidad y consistencia visual para lograr una experiencia centrada en el usuario.  <br> <br> **TB2**: Participé en el desarrollo de la aplicación móvil para conductores utilizando Kotlin, lo que me permitió actualizar mis conocimientos sobre desarrollo nativo en Android y el uso de herramientas como ViewModel, LiveData y Retrofit. Además, colaboré en la elaboración de la documentación técnica del sistema, fortaleciendo mi comprensión sobre la importancia de una comunicación clara y estructurada en proyectos de software. <br>  **TF**:Se pudieron implementar nuevas funcionalidades clave para el flujo del usuario tanto de pasajero, como funcionalidades del busqueda y detalle de viaje. <br> | **General**: En este avance del TP, correspondiente a los capítulos 5 y 6 del informe, se consolidó la actualización de conocimientos clave en diseño UI/UX, arquitectura de la información y metodologías ágiles de desarrollo, aplicando estándares y buenas prácticas propias de la ingeniería de software profesional. El equipo profundizó en el uso de herramientas modernas para la gestión de estilos, la estructuración de la información y la validación de producto, lo que permitió fortalecer competencias técnicas y metodológicas alineadas con las exigencias actuales del sector. |
| **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.**  | **David Polanco, Alessandro Alonso**, <br><br>**TB1**: El desarrollo de TB1 nos hizo conscientes de que el aprendizaje constante es fundamental en el campo de la ingeniería de software. Enfrentar una problemática real como la movilidad estudiantil nos impulsó a investigar nuevas metodologías, comprender mejor el entorno y mejorar nuestras habilidades de comunicación, análisis y documentación. <br><br> **TP**: El avance alcanzado en los capítulos 5 y 6 evidenció la importancia del aprendizaje continuo, ya que el equipo debió investigar nuevas tecnologías, metodologías de diseño y frameworks de desarrollo para responder a los retos específicos del proyecto. <br><br>**TB2**: El avance del Sprint 2 del capitulo 6 evidencio la importancia de una buena integración como equipo para ir desarrollando a la par la app móvil y el backend para que haya una conexión rápida y eficiente. <br><br> **TF**:Se reconoció la importancia del aprendizaje y trabajo en equipo, de esta manera pudimos coordinar tareas y lograr realizar un trabajo satisfactorio sin ningun quiebre durante los sprints. **Chirinos Zúñiga, Rodrigo Manuel**, <br><br>**TB1**: Se reconoció la importancia del aprendizaje continuo y se aplicó en el desarrollo de soluciones de software, integrando nuevos conocimientos y metodologías en la entrega de este primer avance del proyecto. <br> <br>**TP** Sabemos que las vistas realizadas en esta entrega pueden cambiar y mejorar permitiendo así una nueva versión mejorada siguiendo las mejores prácticas. <br> <br> **TB2**: El desarrollo de la app móvil para conductores en Kotlin tuve que investigar bastante y hacer uso de bibliotecas y interesantes para presentar el trabajo de manera adecuada. Eso me motivó a seguir aprendiendo acerca de Kotlin y sus diversas funcionalidades. <br> <br>**TF**:Se reconoció la importancia del trabajo en equipo, de esta manera pudimos coordinar tareas y lograr realizar un trabajo satisfactorio sin ningun quiebre durante los sprints. <br><br>**Cruz Ticona, Aaron Alejandro**, <br><br>**TB1**: La necesidad de estructurar correctamente los bounded contexts y representar fielmente los procesos del dominio me llevó a investigar y aplicar patrones avanzados de diseño de software.<br> <br>**TP**: Se desarrollo la primera fase de la aplicacion durante el sprint donde ya podremos visualizar los planes disponibles para los usuarios.<br><br>**TB2**: Aprendizaje de nuevas tecnologías móviles para desarrollo ágil. <br><br>**TF**: Coordinación técnica y aprendizaje compartido con el equipo.<br><br>   **Zevallos Linares, Alessandro Netto**, <br><br>**TB1**: Documentar la arquitectura del sistema en capas me motivó a investigar a fondo sobre patrones de diseño y principios de DDD, especialmente en cuanto a la identificación correcta de bounded contexts y la relación entre las capas. <br> <br> **TP**: El desarrollo de los diseños UX/UI tanto para la web como para móviles requirió estudiar tendencias actuales en diseño, buenas prácticas de experiencia de usuario, así como el manejo de herramientas como Figma y sistemas de diseño. <br> <br> **TB2**: El desarrollo de la app móvil para conductores en Kotlin me motivó a investigar nuevas prácticas de arquitectura en Android y el uso eficiente de bibliotecas modernas para la gestión del ciclo de vida y la comunicación con servicios externos. Asimismo, al colaborar en la documentación técnica, comprendí la importancia de actualizar constantemente mis conocimientos para comunicar de forma efectiva soluciones técnicas. Estas actividades reafirmaron la necesidad del aprendizaje continuo para adaptarme a las exigencias del desarrollo de software en entornos cambiantes.  <br>**TF**:Se trabajo en conjunto con el equipo para el desarrollo de app y cumplir con los plazos del sprint. <br> | **General**: El desarrollo de los capítulos 5 y 6 para el TP puso de manifiesto la importancia del aprendizaje continuo como parte fundamental del ejercicio profesional en ingeniería de software. El equipo se enfrentó a nuevos retos técnicos y de diseño que requirieron la búsqueda activa de información, la actualización constante en tendencias tecnológicas y la incorporación de retroalimentación de usuarios y expertos durante la validación del producto.                                                                                                                          |
...
| Link mobile Backend          | https://github.com/AppsMoviles-7128-Grupo-3/GoUni-Backend             |
